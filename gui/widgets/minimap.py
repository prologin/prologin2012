...
class MinimapWidget(BaseWidget):
    ...
    def update_game(self, game_state):
        ...
        self.ratio_x = float(self.map_widget.width) / great_map[0]
        self.ratio_y = float(self.map_widget.height) / great_map[1]
        self.update_view()
