...
std::string convert_to_string(attaque_type in)
{
    ...
    case ATTAQUE_NORMALE:
        return "\"attaque_normale\"";
    case ATTAQUE_PALANTIR:
        return "\"attaque_palantir\"";
    case ATTAQUE_TRAITRISE:
        return "\"attaque_traitrise\"";
    case ATTAQUE_BASTOOOON:
        return "\"attaque_bastoooon\"";
    case ATTAQUE_FUS_RO_DAH:
        return "\"attaque_fus_ro_dah\"";
    case ATTAQUE_I_SEE:
        return "\"attaque_i_see\"";
    case ATTAQUE_LOTO:
        return "\"attaque_loto\"";
    }
    return "bad value";
...
std::string convert_to_string(erreur in)
{
    switch (in)
    {
    case POSITION_IMPOSSIBLE:
        return "\"position_impossible\"";
    case PERSONNAGE_IMPOSSIBLE:
        return "\"personnage_impossible\"";
    case CHEMIN_IMPOSSIBLE:
        return "\"chemin_impossible\"";
    case ATTAQUE_INDISPONIBLE:
...
///
// Renvoie la longueur du chemin le plus court entre deux points. Renvoie -1 en
// cas de positions invalides ou de chemin inexistant.
//
...
///
// Renvoie le chemin le plus court entre deux points. Si le chemin n'existe pas,
// ou si les positions sont invalides, le chemin renvoyé est vide.
//
...
//
extern "C" erreur api_perso_deplace(perso_info perso,
...
///
// Récupère la liste des zones sur lesquelles l'elfe peut voir des personnages
// via son attaque "I See What You Did There".
//
...
// ``pos``.
//
extern "C" erreur api_perso_attaque(perso_info perso, attaque_type attaque,
                                    position pos)
{
...
// personnage ``perso``.
//
extern "C" int api_perso_attaque_recharge(perso_info perso,
                                          attaque_type attaque)
{
...
std::ostream& operator<<(std::ostream& os, attaque_type v)
{
    ...
    case ATTAQUE_PALANTIR:
        ...
        break;
    case ATTAQUE_TRAITRISE:
        os << "ATTAQUE_TRAITRISE";
        break;
    case ATTAQUE_BASTOOOON:
        os << "ATTAQUE_BASTOOOON";
        break;
    case ATTAQUE_FUS_RO_DAH:
        os << "ATTAQUE_FUS_RO_DAH";
        break;
    case ATTAQUE_I_SEE:
        os << "ATTAQUE_I_SEE";
        break;
...
std::ostream& operator<<(std::ostream& os, erreur v)
{
    ...
    {
    case POSITION_IMPOSSIBLE:
        os << "POSITION_IMPOSSIBLE";
        break;
    case PERSONNAGE_IMPOSSIBLE:
        os << "PERSONNAGE_IMPOSSIBLE";
        break;
    case CHEMIN_IMPOSSIBLE:
        os << "CHEMIN_IMPOSSIBLE";
        break;
    case ATTAQUE_INDISPONIBLE:
        os << "ATTAQUE_INDISPONIBLE";
        break;
    case OK:
        os << "OK";
        break;
